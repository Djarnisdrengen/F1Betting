...
CREATE TABLE settings (
    ...
    rumor_batch_size INT NOT NULL DEFAULT 6,
    trivia_batch_size INT NOT NULL DEFAULT 6
);

-- Indsæt standard indstillinger
INSERT INTO settings (id, app_title, app_year, hero_title_en, hero_title_da, hero_text_en, hero_text_da, points_p1, points_p2, points_p3, points_wrong_pos, betting_window_hours, bet_size, challenge_rumor_deck_size, challenge_invite_daily_cap, challenges_enabled, home_recap_count, rumor_batch_size, trivia_batch_size) VALUES
